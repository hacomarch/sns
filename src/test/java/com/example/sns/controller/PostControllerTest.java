...
public class PostControllerTest {
    ...
    @Test
    @WithAnonymousUser
    void 포스트_작성시_로그인하지않은_경우() throws Exception{
    ...
    void 포스트_수정() throws Exception{
        ...
        when(postService.modify(eq(title), eq(body), any(), any()))
                .thenReturn(Post.formEntity(PostEntityFixture.get("userName", 1, 1)));
    ...
    @Test
    @WithMockUser
    void 포스트_수정시_본인이_작성한_글이_아닐경우_에러발생() throws Exception{
    ...
    @Test
    @WithMockUser
    void 포스트_수정시_수정하려는_글이_없는경우_에러발생() throws Exception{
    ...
    @Test
    @WithMockUser
    void 포스트_삭제시_작성자와_삭제요청자가_다를경우() throws Exception{
    ...
    @Test
    @WithMockUser
    void 포스트_삭제시_삭제하려는_포스트가_존재하지_않을경우() throws Exception{
